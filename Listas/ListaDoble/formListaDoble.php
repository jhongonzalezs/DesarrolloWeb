...
<body>
    <div class="container">
        <div class="login-container">
            <form action="metodosListasDoble.php" method="POST">
        ...
        <div class="login-container4">
            <form action="vaciarDoble.php" method="POST">
        ...
        <div class="login-container6">
            <form action="MostrarListaDoble.php" method="POST">
